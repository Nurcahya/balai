		...
		<div class="container-fluid" id="pcont">
		  <div class="cl-mcont">
			...
			<div class="stats_bar">
				...
				<div class="sub"><h2>JATI LUHUR</h2><span>170 Meter</span></div>
					<div class="stat"><span class="down">25 Meter</span></div>
				</a>
				<a href="monitor/SM" class="butpro butstyle">
					<div class="sub"><h2>SEMPOR</h2><span>11 Meter</span></div>
					<div class="stat"><span class="up"> 3 Meter</span></div>
				</a>
				<a href="monitor/KO" class="butpro butstyle">
					<div class="sub"><h2>KEDUNG OMBO</h2><span>25 Meter</span></div>
					<div class="stat"><span class="down"> 20 Meter</span></div>
				</a>
				<a href="monitor/SR" class="butpro butstyle">
					<div class="sub"><h2>SERMO</h2><span>18 Meter</span></div>
					<div class="stat"><span class="equal"> 0 Meter</span></div>
				</a>	
				<a href="monitor/BT" class="butpro butstyle">
					<div class="sub"><h2>BATU TEGI</h2><span>12 Meter</span></div>
					<div class="stat"><span class="down">5 Meter</span></div>
				</a>
			</div>
				...
				<div class="col-sm-6 col-md-6 col-lg-4" style="width:33% !important">
					<div class="widget-block">
						...
						<div class="header no-border">
							...
							<div class="content">
							<!--<img src="<?php echo base_url();?>assets/upload/1.jpg" width="100%">-->
