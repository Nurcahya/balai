        ...
        <div class="maincontent">
			...
			<?php
               ...
               /* $dir = "<?php echo base_url();?>assets/upload/citra"; */
                $dir = "C:/xampp5.5/htdocs/balai/assets/upload/vr";
                $dh  = opendir($dir);
                while (false !== ($filename = readdir($dh))) {
                    $jum = $jum+1;
                    $fullpath = "C:/xampp5.5/htdocs/balai/assets/upload/vr/".$filename;
                    echo "<tr><td>".$jum."</td><td>";
                    echo $filename."</td><td>".filesize($fullpath)." byte</td><td>".date ("F d Y H:i:s.", filemtime($fullpath))."</td>";
                    echo "<td><a  href='".site_url()."admin/ftpvw/pindah/".$filename."' onclick='newDoc(".$jum.")'>Backup</a></td></tr>";
                }
