...
$db['default']['password'] = '';
$db['default']['database'] = 'balaibendungan';
...
$db['default']['hostname'] = 'https://sartika-ms.com/webapps/phpmyadmin';
$db['default']['username'] = 'k0441236_ffws';
$db['default']['password'] = 'ffwsdatabas3';
$db['default']['database'] = 'k0441236_ffws';
$db['default']['dbdriver'] = 'mysql';
$db['default']['dbprefix'] = '';
